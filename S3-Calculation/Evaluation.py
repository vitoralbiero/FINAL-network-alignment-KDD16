...
class AlignmentQuality:
    ...
    def PF(self):
        ...
        # dictionary, where keyed on GO terms and the values are the genes annotated with the key
        go_nodes1 = self.GO_related_genes(self.node_set1, self.goterm_dict1)
