function final_pair(netpath1, netpath2, ground_truth_path)
...
%% Saves the matrix:
csvwrite(strcat(substring(netpath1, 1..strlength(netpath1)-4), '_vs_', substring(netpath1, 1..strlength(netpath1)-4)), S);
